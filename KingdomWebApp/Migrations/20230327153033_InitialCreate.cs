        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GuildCategory = table.Column<int>(type: "int", nullable: false),
                    GuildSubcategory = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Guilds_Addresses_AddressId",
                        column: x => x.AddressId,
                        principalTable: "Addresses",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Guilds_AspNetUsers_AppUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TradeSubcategory = table.Column<int>(type: "int", nullable: false),
                    AppUserId = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Trades_Addresses_AddressId",
                        column: x => x.AddressId,
                        principalTable: "Addresses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SupplyOwners", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Guilds_AddressId",
                table: "Guilds",
                column: "AddressId");

            migrationBuilder.CreateIndex(
                name: "IX_Guilds_AppUserId",
                table: "Guilds",
                column: "AppUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Guilds_CityId",
                table: "Guilds",
                column: "CityId");

            migrationBuilder.CreateIndex(
                name: "IX_Guilds_StateId",
                table: "Guilds",
                column: "StateId");
